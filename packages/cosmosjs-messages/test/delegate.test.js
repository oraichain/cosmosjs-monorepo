...
describe('delegate with cosmos-messages correctly', () => {
  it('should delegate correctly', async () => {
    const childKey = cosmos.getChildKey(process.env.SEND_MNEMONIC);
    const message = CosmosMessages.getMsgDelegate(cosmos.getAddress(childKey), "oraivaloper18hr8jggl3xnrutfujy2jwpeu0l76azprkxn29v", { denom: "orai", "amount": "1" });
