...
declare class OraiwasmJs extends Cosmos {
  ...
  execute(params: { signerOrChild: bip32.BIP32Interface | OfflineDirectSigner, rawInputs: RawInput[], fees?: number | any[], gasLimits?: number | string, memo?: string | undefined, gasMultiplier?: number, timeoutHeight?: number, timeoutIntervalCheck?: number, broadcastMode?: string }): Promise<any>;
